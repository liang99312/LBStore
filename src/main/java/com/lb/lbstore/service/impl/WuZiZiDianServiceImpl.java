...
public class WuZiZiDianServiceImpl implements WuZiZiDianService {
    ...
    public int queryRows(HashMap map) {
        String sql = "select count(1) from WuZiZiDian where qy_id="+map.get("qy_id");
    ...
    public List<WuZiZiDian> queryWuZiZiDiansByPage(HashMap map) {
        ...
        return wuZiZiDianDao.getPageList(hql, null, Integer.parseInt(map.get("beginRow").toString()), Integer.parseInt(map.get("pageSize").toString()));
    }
