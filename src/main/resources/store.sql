...
CREATE TABLE `store`.`wuzixhgg` (
  ...
  `jb` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  `bzq` INT DEFAULT 0,
  PRIMARY KEY (`id`))ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;
...
CREATE TABLE `store`.`rukudetail` (
  ...
  `wzbm` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `wzlb_id` INT NOT NULL,
  ...
  `pc` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `scrq` datetime DEFAULT NULL,
  `bzq` INT DEFAULT 0,
  `dj` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  ...
  `bzgg` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  `sl` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  `zl` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
...
CREATE TABLE `store`.`kucun` (
  ...
  `dj` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  `ckdj` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  `dw` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `zldw` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `jlfs` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bzgg` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  `sl` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  `syl` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  `zl` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  `syzl` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  `tysx` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `dymx` varchar(4000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `kw` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `store`.`lingliaodetail` (
  ...
  `jlfs` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bzgg` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  `sll` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  `slzl` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  `tysx` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `dymx` varchar(4000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `kw` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bz` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `store`.`fahuodetail` (
  ...
  `jlfs` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bzgg` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  `fhl` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  `fhdj` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  `fhzl` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  `tysx` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `dymx` varchar(4000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `kw` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bz` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `store`.`sunhaodetail` (
  ...
  `jlfs` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bzgg` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  `shl` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  `shzl` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  `tysx` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `dymx` varchar(4000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `kw` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bz` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `store`.`huankudetail` (
  ...
  `jlfs` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bzgg` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  `hkl` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  `hkzl` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  `tysx` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `dymx` varchar(4000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `kw` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bz` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `store`.`tuihuodetail` (
  ...
  `jlfs` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bzgg` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  `thl` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  `thzl` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  `tysx` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `dymx` varchar(4000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `kw` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bz` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `store`.`tuigongdetail` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `qy_id` INT NOT NULL,
  `ck_id` INT NOT NULL,
  `tg_id` INT NOT NULL,
  ...
  `jlfs` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bzgg` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  `tgl` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  `tgzl` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  `tysx` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `dymx` varchar(4000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `kw` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bz` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `store`.`xiangmu` (
  ...
  `wz` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `dh` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `jhsl` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  `wcsl` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  `fhsl` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  `jhje` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  `wcje` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  `fhje` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  `yfje` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  `dfje` FLOAT(19,2) COLLATE utf8_unicode_ci DEFAULT 0,
  `kdsj` datetime DEFAULT NULL,
  `spsj` datetime DEFAULT NULL,
...
CREATE TABLE `store`.`xiangmudetail` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `qy_id` INT NOT NULL,
  `xm_id` INT NOT NULL,
  `kh_id` INT NULL,
