...
jQuery.bootstrapLoading = {
    start: function (options) {
        ...
        var _LoadingTop = _PageHeight > _LoadingTipsH ? (_PageHeight - _LoadingTipsH) / 3 : 0,
