...
function selectSunHao() {
    ...
    if ($("#selState").val() !== '' && $("#selState").val() !== "-9") {
        sunHao.state = parseInt($("#selState").val());
    }
...
function selectSunHao_m() {
    ...
    if ($("#inpSelState").val() !== '' && $("#inpSelState").val() !== "-9") {
        sunHao.state = parseInt($("#inpSelState").val());
    }
...
function saveSunHao() {
    ...
    sunHao.yy = $("#inpYy").val();
    sunHao.bz = $("#inpBz").val();
    sunHao.sl = parseFloat($("#inpSl").val());
    sunHao.je = parseFloat($("#inpJe").val());
    sunHao.sj = $("#inpSj").val();
    sunHao.state = 0;
...
function saveSunHaoMingXi() {
    ...
    if ($("#inpMxShl").val() === "" || parseFloat($("#inpMxShl").val()) < 0.00001) {
